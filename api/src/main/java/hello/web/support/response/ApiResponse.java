package hello.web.support.response;

import hello.web.support.error.ErrorMessage;
...
public class ApiResponse<S> {
    ...
    public static ApiResponse<?> error(String errorMessage) {
        return new ApiResponse<>(ResultType.FAILURE, null, new ErrorMessage(errorMessage));
    }
